...
function DisplayCard({
	...
	return (
		<a
			...
			onClick={handleClick}
			className={cn(
				'relative flex h-36 w-full max-w-[16rem] sm:max-w-[20rem] right-12 -skew-y-[8deg] select-none flex-col justify-between rounded-xl border-2 bg-muted/70 backdrop-blur-sm px-4 py-3 transition-all duration-700 [&>*]:flex [&>*]:items-center [&>*]:gap-2',
				className,
			)}
		>
